...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@bro-code/types"
...
export const toolParamNames = [
	...
	"files",
	"line_ranges",
	"key", // read_state/write_state parameter
	"format", // write_state parameter
	"tier", // new_task parameter for per-step model routing (Feature 2)
] as const
...
export type NativeToolArgs = {
	...
	read_file: import("@bro-code/types").ReadFileToolParams
	...
	read_state: { key: string }
	write_state: { key: string; content: string; format?: "json" | "markdown" }
...
export const TOOL_DISPLAY_NAMES: Record<ToolName, string> = {
	...
	read_state: "read agent state",
	write_state: "write agent state",
} as const
