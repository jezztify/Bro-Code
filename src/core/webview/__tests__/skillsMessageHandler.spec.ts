...
import type { SkillMetadata, WebviewMessage } from "@bro-code/types"
...
describe("skillsMessageHandler", () => {
	...
	const mockSkills: SkillMetadata[] = [
		...
		},
		{
			...
			path: "/project/.bro/skills/project-skill/SKILL.md",
			source: "project",
			mode: "code",
		},
	]
	...
	describe("handleOpenSkillFile", () => {
		...
		it("opens a skill file with mode restriction", async () => {
			...
			expect(openFile).toHaveBeenCalledWith("/project/.bro/skills/project-skill/SKILL.md")
		})
