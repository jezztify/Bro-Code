// npx vitest core/ignore/__tests__/BroIgnoreController.security.spec.ts

import type { Mock } from "vitest"

import { BroIgnoreController } from "../BroIgnoreController"
...
describe("BroIgnoreController Security Tests", () => {
	...
	beforeEach(async () => {
		...
		// By default, setup .broignore to exist with some patterns
