...
>>>>>>> REPLACE`
		...
		it("should match content with smart quotes", async () => {
			const originalContent =
				"**Enjoy Bro Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/BroCode/) or [Discord](https://discord.gg/VxfP4Vx3gX). Happy coding!"
			const diffContent = `test.ts
<<<<<<< SEARCH
**Enjoy Bro Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/BroCode/) or [Discord](https://discord.gg/VxfP4Vx3gX). Happy coding!
=======
