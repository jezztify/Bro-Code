...
export class ProviderSettingsManager {
	 ...
	 * save/activate flows must not do this implicitly.
	 */
	 ...
	 * existing set (defaulting to the currently active set) unless seedFromId is explicitly
	 * omitted-as-empty via `seedEmpty`.
	 */
