...
describe("processUserContentMentions", () => {
	...
	let mockBroIgnoreController: any

	beforeEach(() => {
		vi.clearAllMocks()

		mockFileContextTracker = {} as FileContextTracker
		mockBroIgnoreController = {}
	...
	describe("showBroIgnoredFiles parameter", () => {
		it("should default showBroIgnoredFiles to false", async () => {
			const userContent = [
				{
					type: "text" as const,
			...
			expect(parseMentions).toHaveBeenCalledWith(
				...
				undefined,
				false, // showBroIgnoredFiles should default to false
		...
		it("should respect showBroIgnoredFiles when explicitly set to false", async () => {
			const userContent = [
				{
					type: "text" as const,
