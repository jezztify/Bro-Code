...
export class DirectoryScanner implements IDirectoryScanner {
	 ...
	 * @param broIgnoreController Optional BroIgnoreController instance for filtering
	...
	public async scanDirectory(
		...
		// Initialize BroIgnoreController if not provided
		const ignoreController = new BroIgnoreController(directoryPath)

		await ignoreController.initialize()

		// Filter paths using .broignore
