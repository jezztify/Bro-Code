...
export class FileWatcher implements IFileWatcher {
	...
	private ignoreController: BroIgnoreController
	...
	constructor(
		...
		ignoreController?: BroIgnoreController,
		batchSegmentThreshold?: number,
	) {
		this.ignoreController = ignoreController || new BroIgnoreController(workspacePath)
		if (ignoreInstance) {
		...
		try {
			...
			if (
				...
				return {
					path: filePath,
					status: "skipped" as const,
					reason: "File is ignored by .broignore or .gitignore",
				}
			}
