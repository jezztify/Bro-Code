 ...
 * Maps to archive names at https://github.com/Bro-Code-Org/sembleexec/releases
 *
...
const DOWNLOAD_BASE_URL = `https://github.com/Bro-Code-Org/sembleexec/releases/download/${SEMBLE_VERSION}`
