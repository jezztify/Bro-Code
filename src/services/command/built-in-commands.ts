...
<initialization>
  ...
  <todo_list_creation>
    ...
    1. Check for existing AGENTS.md files
       ...
       - .bro/rules-code/AGENTS.md (relative to project root)
       - .bro/rules-debug/AGENTS.md (relative to project root)
       - .bro/rules-ask/AGENTS.md (relative to project root)
       - .bro/rules-architect/AGENTS.md (relative to project root)
       ...
       - .cursorrules, CLAUDE.md, .brorules
    ...
    8. Compile/Update AGENTS.md files
       ...
       - Create mode-specific files in .bro/rules-*/ directories (IN PROJECT ROOT)
...
<analysis_workflow>
  ...
  1. **Discovery Phase**:
     ...
     IMPORTANT: The .bro folder should be created in the PROJECT ROOT, not system root!
...
<output_structure>
  ...
  <mode_specific_files>
    ...
    - .bro/rules-code/AGENTS.md (create .bro in project root, not system root!)
    - .bro/rules-debug/AGENTS.md (relative to project root)
    - .bro/rules-ask/AGENTS.md (relative to project root)
    - .bro/rules-architect/AGENTS.md (relative to project root)
    
    IMPORTANT: The .bro directory must be created in the current project/workspace root directory,
    ...
    ├── .bro/                        # IN PROJECT ROOT, NOT SYSTEM ROOT!
    │   ├── rules-code/
    ...
    .bro/rules-code/AGENTS.md - ONLY non-obvious coding rules discovered by reading files:
    ...
    .bro/rules-debug/AGENTS.md - ONLY non-obvious debugging discoveries:
    ...
    .bro/rules-ask/AGENTS.md - ONLY non-obvious documentation context:
    ...
    .bro/rules-architect/AGENTS.md - ONLY non-obvious architectural constraints:
