...
import { ModeConfig, GroupEntry, PromptComponent, ToolGroup, modeConfigSchema } from "@bro-code/types"
...
import { TOOL_GROUPS } from "@bro/tools"
								...
								span: (
									<span
										...
										onClick={() => {
											...
											vscode.postMessage({
												type: "openFile",
												text: `./.bro/rules-${currentMode.slug}/rules.md`,
												values: {
													create: true,
													content: "",
												},
