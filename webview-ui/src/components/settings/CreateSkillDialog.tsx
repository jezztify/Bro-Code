...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@bro-code/types"
...
/**
 * Validate skill name using shared validation from @bro-code/types.
