...
describe("ContextManagementSettings", () => {
	...
	it("renders other context management settings", () => {
		...
		expect(screen.getByTestId("show-broignored-files-checkbox")).toBeInTheDocument()
	...
	it("renders with autoCondenseContext enabled", () => {
		...
		// Should render the threshold profile select dropdown, plus the always-present
		// condensing API config dropdown
	...
	describe("Auto Condense Context functionality", () => {
		...
		it("shows threshold settings when auto condense is enabled", () => {
			...
			// Threshold profile selection, plus the always-present condensing API config dropdown
	...
	describe("Accessibility", () => {
		it("has proper labels and descriptions", () => {
			...
			expect(screen.getByText("settings:contextManagement.broignore.label")).toBeInTheDocument()
			...
			expect(screen.getByText("settings:contextManagement.broignore.description")).toBeInTheDocument()
		})
