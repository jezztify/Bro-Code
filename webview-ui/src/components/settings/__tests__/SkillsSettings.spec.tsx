...
import type { SkillMetadata } from "@bro-code/types"
...
const mockSkills: SkillMetadata[] = [
	{
		...
		path: "/workspace/.bro/skills/project-skill/SKILL.md",
		source: "project",
	},
	{
		name: "project-mode-skill",
		description: "A project mode-specific skill",
		path: "/workspace/.bro/skills/project-mode-skill/SKILL.md",
		source: "project",
		modeSlugs: ["architect"],
	},
	{
		...
		path: "/home/.bro/skills/global-skill/SKILL.md",
		source: "global",
	},
]
