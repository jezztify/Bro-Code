...
const SettingsView = forwardRef<SettingsViewRef, SettingsViewProps>(({ onDone, targetSection }, ref) => {
	...
	// draft: selecting a different profile in the dropdown only previews its settings
	// for editing and must not activate it (mutate global state, the mode's provider
	// mapping, or the live task's API handler) until the user explicitly saves.
					...
					<SearchIndexProvider value={searchContextValue}>
						...
						{renderTab === "autoApprove" && (
							<AutoApproveSettings
								...
								alwaysAllowBoardTasks={alwaysAllowBoardTasks}
