...
import type { Mode } from "@bro/modes"
...
vi.mock("@/components/ui/hooks/useBroPortal", () => ({
	useBroPortal: () => document.body,
}))
...
vi.mock("@bro/modes", async () => {
	const actual = await vi.importActual<typeof import("@bro/modes")>("@bro/modes")
	return {
		...actual,
