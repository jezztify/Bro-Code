	...
	useTranslation: () => ({
		t: (key: string) => {
			const translations: Record<string, string> = {
				"chat:slashCommand.wantsToRun": "Bro wants to run slash command:",
				"chat:slashCommand.didRun": "Bro ran slash command:",
			}
...
describe("ChatRow - runSlashCommand tool", () => {
	...
	it("should display runSlashCommand ask message with command only", () => {
		...
		expect(getByText("Bro wants to run slash command:")).toBeInTheDocument()
	...
	it("should display runSlashCommand say message", () => {
		...
		expect(getByText("Bro ran slash command:")).toBeInTheDocument()
