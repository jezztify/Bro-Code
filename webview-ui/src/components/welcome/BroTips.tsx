...
const tips = [
	{
		...
		titleKey: "broTips.customizableModes.title",
		descriptionKey: "broTips.customizableModes.description",
	},
	{
		icon: <ReplaceAll className="size-4 shrink-0 mt-0.5" />,
		href: buildDocLink("getting-started/connecting-api-provider", "tips"),
		titleKey: "broTips.modelAgnostic.title",
		descriptionKey: "broTips.modelAgnostic.description",
	},
]
