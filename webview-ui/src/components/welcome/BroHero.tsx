		...
		<div
			...
			<div
				style={{
					...
					WebkitMaskImage: `url('${imagesBaseUri}/bro-logo.svg')`,
					WebkitMaskRepeat: "no-repeat",
					WebkitMaskSize: "contain",
					maskImage: `url('${imagesBaseUri}/bro-logo.svg')`,
