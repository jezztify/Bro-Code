...
// pnpm --filter @bro-code/telemetry test src/__tests__/PostHogTelemetryClient.test.ts

import * as vscode from "vscode"
import { PostHog } from "posthog-node"

import { type TelemetryPropertiesProvider, TelemetryEventName, ApiProviderError } from "@bro-code/types"
