 ...
 *
 * This writes logs to ~/.bro/cli-debug.log, avoiding stdout/stderr
 * which would break TUI applications. The log format is timestamped JSON.
 *
 * Usage:
 *   import { debugLog, DebugLogger } from "@bro-code/core/cli"
 *
 *   // Simple logging
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".bro", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.bro/cli-debug.log
