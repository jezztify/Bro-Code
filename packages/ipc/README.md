...
This package provides IPC functionality for Bro Code, allowing external applications to communicate with the extension through a socket-based interface.
...
- `configuration`: BroCode settings object
...
```typescript
import { IpcClient } from "@bro-code/ipc"
...
- Unix/Linux/macOS: `/tmp/bro-code-{id}.sock`
- Windows: `\\.\pipe\bro-code-{id}`
