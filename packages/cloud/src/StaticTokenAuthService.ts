...
import type { JWTPayload, CloudUserInfo, AuthService, AuthServiceEvents, AuthState } from "@bro-code/types"
...
export class StaticTokenAuthService extends EventEmitter<AuthServiceEvents> implements AuthService {
	...
	public async getOrganizationMemberships(): Promise<import("@bro-code/types").CloudOrganizationMembership[]> {
		throw new Error("Authentication methods are disabled in StaticTokenAuthService")
	}
