/**
 * Validates the generated schemas/bromodes.json against sample configurations
 * using AJV. The schema itself is dynamically generated from the Zod types in
 * packages/types/src/mode.ts -- see packages/types/scripts/generate-bromodes-schema.ts.
 *
 * A separate drift-detection test (bromodes-schema-sync.spec.ts) ensures the
...
describe("bromodes JSON schema", () => {
	...
	it("should accept a minimal valid .bromodes config", () => {
		const config = {
			customModes: [
				{
					slug: "my-mode",
