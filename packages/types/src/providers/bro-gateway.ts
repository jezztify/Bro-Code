...
// Bro Gateway uses the same model ID format as Vercel AI Gateway (provider/model-name)
export const broGatewayDefaultModelId = "anthropic/claude-sonnet-4"

// Bro Gateway serves the same models as Vercel AI Gateway, so prompt caching support is identical
...
export { VERCEL_AI_GATEWAY_PROMPT_CACHING_MODELS as BRO_GATEWAY_PROMPT_CACHING_MODELS } from "./vercel-ai-gateway.js"

export const broGatewayDefaultModelInfo: ModelInfo = {
	maxTokens: 64000,
...
export const BRO_GATEWAY_DEFAULT_TEMPERATURE = 0.7
