 ...
 * propagates through `modeConfigSchema → broCodeSettingsSchema → createRunSchema`
...
export const modeConfigSchema = z.object({
	...
	includeInSystemPrompt: z
		.boolean()
		.optional()
		.describe(
			"Whether this mode is listed in the MODES section of the system prompt. Defaults to true when omitted.",
		),
...
export const promptComponentSchema = z.object({
	...
	description: z.string().optional(),
	customInstructions: z.string().optional(),
	includeInSystemPrompt: z.boolean().optional(),
})
...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		name: "🏗️ Architect",
		roleDefinition:
			"You are Bro, an experienced technical leader who is inquisitive and an excellent planner. Your goal is to gather information and get context to create a detailed plan for accomplishing the user's task, which the user will review and approve before they switch into another mode to implement the solution.",
		whenToUse:
	...
	// 	name: "💻 Code",
	// 	roleDefinition:
	// 		"You are Bro, a highly skilled software engineer with extensive knowledge in many programming languages, frameworks, design patterns, and best practices.",
	// 	whenToUse:
	...
	// 	name: "❓ Ask",
	// 	roleDefinition:
	// 		"You are Bro, a knowledgeable technical assistant focused on answering questions and providing information about software development, technology, and related topics.",
	// 	whenToUse:
	...
	// },
	{
		...
		name: "🪲 Debug",
		roleDefinition:
			"You are Bro, an expert software debugger specializing in systematic problem diagnosis and resolution.",
		whenToUse:
