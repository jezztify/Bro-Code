...
### 3. Bro Code समुदाय से जुड़ें

- **Discord:** हमारे [Discord](https://discord.gg/VxfP4Vx3gX) से जुड़ें।
- **Reddit:** हमारे [Reddit](https://www.reddit.com/r/BroCode/) से जुड़ें।
...
- **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/Bro-Code-Org/Bro-Code/issues) में खोजें।
...
- Issues के लिए [GitHub Issues page](https://github.com/Bro-Code-Org/Bro-Code/issues) देखें।
- दस्तावेज़ों के लिए, [Bro Code दस्तावेज़](https://github.com/Bro-Code-Org/Bro-Code-Docs) पर जाएँ।

### बग की रिपोर्ट करना

- पहले मौजूदा रिपोर्ट की जाँच करें।
- ["बग रिपोर्ट" टेम्पलेट](https://github.com/Bro-Code-Org/Bro-Code/issues/new/choose) का उपयोग करके एक नया बग बनाएँ:
    - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
    - अपेक्षित बनाम वास्तविक परिणाम
    - Bro Code संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
- **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/Bro-Code-Org/Bro-Code/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें।
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो Bro Code के लाइसेंस के अनुरूप है।
