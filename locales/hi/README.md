<p align="center">
        ...
        <p align="center">
          <em>जल्दी मदद पाएं → <a href="https://discord.gg/VxfP4Vx3gX">Discord जॉइन करें</a> • Async पसंद है? → <a href="https://www.reddit.com/r/BroCode/">r/BroCode जॉइन करें</a></em>
        </p>
...
> आपने शायद Bro टीम 🦘🦘🦘 की [हाल की घोषणा](https://x.com/mattrubens/status/2046636598859559114) देखी होगी। TLDR यह है कि टीम [Bromote](https://bromote.dev/) पर focus करते हुए Bro Code का active development धीरे-धीरे बंद कर रही है। यह खबर बहुत से Bro users के लिए मुश्किल थी; यह plugin इस community के लिए बहुत मायने रखता है।
>
> हम पूरे Bro टीम को इस plugin पर लगाए गए उनके काम के लिए धन्यवाद देना चाहते हैं। हम यहाँ हर व्यक्ति का नाम अलग-अलग नहीं लेंगे, लेकिन हम सब इस बात से सहमत हो सकते हैं कि वे exceptional developers हैं और, उतना ही ज़रूरी, incredible लोग भी हैं। Bro टीम को धन्यवाद।
>
> Bro users हर तरह के हैं। कुछ लोग इसे अपने day-to-day professional काम में इस्तेमाल करते हैं, कुछ लोग इससे बेहद जटिल workflows बनाते हैं। कुछ लोग खुद Bro को बेहतर बनाते हैं, जबकि कुछ वही models बेहतर बनाते हैं जिन्हें Bro इस्तेमाल करता है (super meta)। हमारी बात बस इतनी है कि community बहुत diverse है, और जबकि kangaroo 🦘🦘🦘 एक शानदार और सम्मानित जानवर है, हमें लगा कि अलग-अलग species वाला "Bro" 🐘🦡🦒🦓🦛🦧🦭🦦 plugin users की इस diversity को बेहतर दिखाता है।
>
> इसलिए हम यह घोषणा करना चाहते हैं कि **Bro Code** इस महत्वपूर्ण project का development जारी रखेगा। Core team ऐसे developers का समूह है जिन्होंने पहले Bro में योगदान दिया है और इस plugin की गहराई से परवाह करते हैं। हम models update करते रहेंगे, bugs fix करते रहेंगे और features release करते रहेंगे। लेकिन सबसे बढ़कर, हम आप community की बात सुनना चाहते हैं, जिसने इस plugin को इतना खास बनाया। इसलिए बेझिझक हमारे [Discord](https://discord.gg/VxfP4Vx3gX), हमारे [Reddit](https://www.reddit.com/r/BroCode) से जुड़ें, या [PR या issue बनाएं](https://github.com/Bro-Code-Org/Bro-Code); लेकिन सबसे ज़्यादा हम आपसे यही कहेंगे कि community के रूप में जुड़े रहें, सक्रिय रहें और शामिल रहें।
>
> _-Bro Code Team_

## Bro Code से Bro Code migration

Bro Code से Bro Code में आने के लिए एक quick guide तुम्हें [Bro→Bro migration guide](https://docs.brocode.dev/bro-to-bro-migration) में मिल जाएगी। We plan to help users as much as possible during the transition, और उसी support के लिए हमारा [Reddit](https://www.reddit.com/r/BroCode) और [Discord](https://discord.gg/VxfP4Vx3gX) है। अगर तुम्हें कोई problem हो या कोई question हो, आकर पूछो।
...
## Bro Code आपके लिए क्या कर सकता है?
...
और जानो: [मोड्स का इस्तेमाल](https://docs.brocode.dev/basic-usage/using-modes) • [कस्टम मोड्स](https://docs.brocode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.brocode.dev/tutorial-videos">अधिक त्वरित ट्यूटोरियल और फ़ीचर वीडियो...</a>
</p>

## संसाधन

- **[दस्तावेज़ीकरण](https://docs.brocode.dev):** Bro Code को स्थापित करने, कॉन्फ़िगर करने और उसमें महारत हासिल करने के लिए आधिकारिक गाइड।
- **[यूट्यूब चैनल](https://youtube.com/@brocodeyt?feature=shared):** ट्यूटोरियल देखें और सुविधाओं को एक्शन में देखें।
- **[डिस्कॉर्ड सर्वर](https://discord.gg/VxfP4Vx3gX):** रीयल-टाइम सहायता और चर्चा के लिए समुदाय में शामिल हों।
- **[रेडिट समुदाय](https://www.reddit.com/r/BroCode):** अपने अनुभव साझा करें और देखें कि दूसरे क्या बना रहे हैं।
- **[गिटहब मुद्दे](https://github.com/Bro-Code-Org/Bro-Code/issues):** बग की रिपोर्ट करें और विकास को ट्रैक करें।
- **[सुविधा अनुरोध](https://github.com/Bro-Code-Org/Bro-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** क्या आपके पास कोई विचार है? इसे डेवलपर्स के साथ साझा करें।
...
वीएसकोड में `F5` दबाएं (या **रन** → **डीबगिंग प्रारंभ करें** पर जाएं)। यह Bro Code एक्सटेंशन के साथ एक नई वीएसकोड विंडो खोलेगा।
...
1.  पहले, VSIX पैकेज बनाएं:
    ...
    pnpm vsix
    ```
2.  `bin/` डायरेक्टरी में एक `.vsix` फ़ाइल जनरेट होगी (जैसे, `bin/bro-code-<version>.vsix` )।
...
**Bro Code का आनंद लें!** चाहे आप इसे short leash पर रखें या इसे autonomously घूमने दें, हम यह देखने के लिए उत्साहित हैं कि आप क्या बनाते हैं। अगर आपके पास questions या feature ideas हैं, तो एक [issue](https://github.com/Bro-Code-Org/Bro-Code/issues) खोलें या एक [discussion](https://github.com/Bro-Code-Org/Bro-Code/discussions) शुरू करें। Happy coding!
