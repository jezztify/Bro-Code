...
### 3. Присоединяйся к сообществу Bro Code

- **Discord:** Присоединяйся к нашему [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Присоединяйся к нашему [Reddit](https://www.reddit.com/r/BroCode/).
...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/Bro-Code-Org/Bro-Code/issues).
...
- Проверь [страницу GitHub Issues](https://github.com/Bro-Code-Org/Bro-Code/issues), чтобы найти issues.
- Для документации посетите [Документацию Bro Code](https://github.com/Bro-Code-Org/Bro-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/Bro-Code-Org/Bro-Code/issues/new/choose) с:
    - Четкими, пронумерованными шагами воспроизведения
    - Ожидаемым и фактическим результатом
    - Версией Bro Code (обязательно); поставщиком/моделью ИИ, если применимо
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/Bro-Code-Org/Bro-Code/security/advisories/new).
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Bro Code.
