...
### 3. Unisciti alla community di Bro Code

- **Discord:** Unisciti al nostro [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Unisciti al nostro [Reddit](https://www.reddit.com/r/BroCode/).
...
- **Controlla le issue esistenti**: cerca nelle [issue di GitHub](https://github.com/Bro-Code-Org/Bro-Code/issues).
...
- Controlla la [pagina GitHub Issues](https://github.com/Bro-Code-Org/Bro-Code/issues) per trovare le issues.
- Per la documentazione, visita [Bro Code Docs](https://github.com/Bro-Code-Org/Bro-Code-Docs).

### Segnalazione di bug

- Controlla prima le segnalazioni esistenti.
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/Bro-Code-Org/Bro-Code/issues/new/choose) con:
    - Passaggi di riproduzione chiari e numerati
    - Risultato previsto vs effettivo
    - Versione di Bro Code (obbligatoria); provider/modello di intelligenza artificiale se pertinente
- **Problemi di sicurezza**: segnala in privato tramite [avvisi di sicurezza](https://github.com/Bro-Code-Org/Bro-Code/security/advisories/new).
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di Bro Code.
