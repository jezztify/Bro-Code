...
Bro Code to projekt społecznościowy i głęboko cenimy każdy wkład. Aby usprawnić współpracę, działamy w oparciu o [podejście „najpierw zgłoszenie”](#podejście-najpierw-zgłoszenie), co oznacza, że wszystkie [żądania ściągnięcia (PR)](#przesyłanie-żądania-ściągnięcia) muszą być najpierw połączone ze zgłoszeniem na GitHubie. Prosimy o uważne zapoznanie się z tym przewodnikiem.
...
### 3. Dołącz do społeczności Bro Code

- **Discord:** Dołącz do naszego [Discorda](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Dołącz do naszego [Reddita](https://www.reddit.com/r/BroCode/).
...
- **Sprawdź istniejące zgłoszenia**: Przeszukaj [zgłoszenia na GitHubie](https://github.com/Bro-Code-Org/Bro-Code/issues).
...
- Sprawdź [stronę GitHub Issues](https://github.com/Bro-Code-Org/Bro-Code/issues), aby znaleźć issues.
- Aby uzyskać dokumentację, odwiedź [dokumentację Bro Code](https://github.com/Bro-Code-Org/Bro-Code-Docs).

### Zgłaszanie błędów

- Najpierw sprawdź istniejące raporty.
- Utwórz nowy błąd, używając szablonu [„Zgłoszenie błędu”](https://github.com/Bro-Code-Org/Bro-Code/issues/new/choose) z:
    - Jasnymi, ponumerowanymi krokami reprodukcji
    - Oczekiwanym a rzeczywistym wynikiem
    - Wersją Bro Code (wymagane); dostawcą/modelem sztucznej inteligencji, jeśli ma to zastosowanie
- **Problemy z bezpieczeństwem**: Zgłoś je prywatnie za pośrednictwem [zaleceń dotyczących bezpieczeństwa](https://github.com/Bro-Code-Org/Bro-Code/security/advisories/new).
...
Przesyłając wkład, zgadzasz się, że Twoje wkłady będą licencjonowane na podstawie licencji Apache 2.0, zgodnie z licencją Bro Code.
