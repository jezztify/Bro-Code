<p align="center">
        ...
        <p align="center">
          <em>Receba ajuda rápido → <a href="https://discord.gg/VxfP4Vx3gX">Entre no Discord</a> • Prefere algo assíncrono? → <a href="https://www.reddit.com/r/BroCode/">Entre no r/BroCode</a></em>
        </p>
...
> Você pode ter visto o [anúncio recente](https://x.com/mattrubens/status/2046636598859559114) da equipe do Bro 🦘🦘🦘. O resumo é que a equipe está reduzindo gradualmente o desenvolvimento ativo do Bro Code enquanto se concentra no [Bromote](https://bromote.dev/). Essa notícia foi difícil para muitos usuários do Bro; esse plugin significa muito para esta comunidade.
>
> Queremos agradecer a toda a equipe do Bro pelo trabalho que colocou neste plugin. Não vamos citar cada pessoa pelo nome aqui, mas todos podemos concordar que eles são desenvolvedores excepcionais e, tão importante quanto isso, pessoas incríveis. Obrigado à equipe do Bro.
>
> Os usuários do Bro vêm de todos os tipos de contextos. Alguns usam profissionalmente no trabalho do dia a dia, outros usam para montar workflows inimaginavelmente complexos. Alguns usam para melhorar o próprio Bro, enquanto outros usam para melhorar os próprios modelos que o Bro utiliza (super meta). O ponto é que a comunidade é diversa e, embora um canguru 🦘🦘🦘 seja um animal distinto e nobre, sentimos que um "Bro" 🐘🦡🦒🦓🦛🦧🦭🦦 refletia melhor essa diversidade dos usuários do plugin.
>
> Por isso, queremos anunciar que **Bro Code** continuará o desenvolvimento deste projeto importante. A equipe principal é formada por desenvolvedores que já contribuíram com o Bro antes e se importam profundamente com esse plugin. Vamos continuar fazendo atualizações de modelos, corrigindo bugs e lançando recursos. Mas, acima de tudo, queremos ouvir vocês, a comunidade que tornou esse plugin tão especial. Então fique à vontade para entrar no nosso [Discord](https://discord.gg/VxfP4Vx3gX), no nosso [Reddit](https://www.reddit.com/r/BroCode), ou [abrir um PR ou uma issue](https://github.com/Bro-Code-Org/Bro-Code); mas, mais do que tudo, pedimos que você continue envolvido, conectado e ativo como comunidade.
>
> _-Bro Code Team_

## Migração do Bro Code para o Bro Code

Você encontra um guia rápido para migrar do Bro Code para o Bro Code no [guia de migração Bro→Bro](https://docs.brocode.dev/bro-to-bro-migration). Queremos ajudar os usuários durante essa transição da melhor forma possível, e é exatamente para isso que temos nosso [Reddit](https://www.reddit.com/r/BroCode) e nosso [Discord](https://discord.gg/VxfP4Vx3gX). Se você tiver algum problema ou dúvida, apareça por lá e pergunte.
...
## O que o Bro Code pode fazer por VOCÊ?
...
O Bro Code se adapta à sua maneira de trabalhar, e não o contrário:
...
Saiba mais: [Usar Modos](https://docs.brocode.dev/basic-usage/using-modes) • [Modos personalizados](https://docs.brocode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.brocode.dev/tutorial-videos">Mais vídeos rápidos de tutorial e recursos...</a>
</p>

## Recursos

- **[Documentação](https://docs.brocode.dev):** O guia oficial para instalar, configurar e dominar o Bro Code.
- **[Canal do YouTube](https://youtube.com/@brocodeyt?feature=shared):** Assista a tutoriais e veja os recursos em ação.
- **[Servidor do Discord](https://discord.gg/VxfP4Vx3gX):** Junte-se à comunidade para ajuda e discussão em tempo real.
- **[Comunidade do Reddit](https://www.reddit.com/r/BroCode):** Compartilhe suas experiências e veja o que os outros estão construindo.
- **[Issues do GitHub](https://github.com/Bro-Code-Org/Bro-Code/issues):** Relate bugs e acompanhe o desenvolvimento.
- **[Solicitações de recursos](https://github.com/Bro-Code-Org/Bro-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Tem uma ideia? Compartilhe com os desenvolvedores.
...
Existem várias maneiras de executar a extensão Bro Code:

### Modo de Desenvolvimento (F5)

Para desenvolvimento ativo, use a depuração incorporada do VSCode:

Pressione `F5` (ou vá para **Executar** → **Iniciar Depuração**) no VSCode. Isso abrirá uma nova janela do VSCode com a extensão Bro Code em execução.
...
1.  Primeiro, construa o pacote VSIX:
    ...
    pnpm vsix
    ```
2.  Um arquivo `.vsix` será gerado no diretório `bin/` (por exemplo, `bin/bro-code-<version>.vsix`).
...
**Observe** que a Bro Code **não** faz representações ou garantias em relação a qualquer código, modelos ou outras ferramentas fornecidas ou disponibilizadas em conexão com o Bro Code, quaisquer ferramentas de terceiros associadas ou quaisquer saídas resultantes. Você assume **todos os riscos** associados ao uso de tais ferramentas ou saídas; tais ferramentas são fornecidas **"COMO ESTÃO"** e **"CONFORME DISPONÍVEIS"**. Tais riscos podem incluir, sem limitação, violação de propriedade intelectual, vulnerabilidades ou ataques cibernéticos, viés, imprecisões, erros, defeitos, vírus, tempo de inatividade, perda ou dano de propriedade e/ou lesões pessoais. Você é o único responsável pelo uso de tais ferramentas ou saídas (incluindo, sem limitação, a legalidade, adequação e resultados das mesmas).
...
**Aproveite o Bro Code!** Seja mantendo tudo na coleira curta ou deixando-o vagar de forma autônoma, mal podemos esperar para ver o que você vai construir. Se você tiver perguntas ou ideias de recursos, abra uma [issue](https://github.com/Bro-Code-Org/Bro-Code/issues) ou inicie uma [discussion](https://github.com/Bro-Code-Org/Bro-Code/discussions). Bom código!
