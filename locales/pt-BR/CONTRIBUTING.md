...
### 3. Junte-se à comunidade do Bro Code

- **Discord:** Entre no nosso [Discord](https://discord.gg/VxfP4Vx3gX).
- **Reddit:** Entre no nosso [Reddit](https://www.reddit.com/r/BroCode/).
...
- **Verifique as issues existentes**: Pesquise nas [Issues do GitHub](https://github.com/Bro-Code-Org/Bro-Code/issues).
...
- Confira a [página de GitHub Issues](https://github.com/Bro-Code-Org/Bro-Code/issues) para ver as issues.
- Para documentação, visite [Documentação do Bro Code](https://github.com/Bro-Code-Org/Bro-Code-Docs).

### Relatando bugs

- Verifique primeiro os relatórios existentes.
- Crie um novo bug usando o [modelo "Relatório de bug"](https://github.com/Bro-Code-Org/Bro-Code/issues/new/choose) com:
    - Passos de reprodução claros e numerados
    - Resultado esperado vs. real
    - Versão do Bro Code (obrigatório); provedor/modelo de IA, se relevante
- **Problemas de segurança**: Relate em particular por meio de [avisos de segurança](https://github.com/Bro-Code-Org/Bro-Code/security/advisories/new).
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Bro Code.
