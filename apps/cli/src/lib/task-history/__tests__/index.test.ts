import { readTaskSessionsFromStoragePath } from "@bro-code/core/cli"
...
vi.mock("@bro-code/core/cli", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@bro-code/core/cli")>()
	return {
		...actual,
