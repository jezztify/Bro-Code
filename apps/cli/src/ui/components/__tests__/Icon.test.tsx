...
describe("Icon", () => {
	...
	describe("Nerd Font detection", () => {
		it("should respect BROCODE_NERD_FONT=1 environment variable", () => {
			process.env.BROCODE_NERD_FONT = "1"
			resetNerdFontCache()
			expect(isNerdFontSupported()).toBe(true)
		})

		it("should respect BROCODE_NERD_FONT=true environment variable", () => {
			process.env.BROCODE_NERD_FONT = "true"
			resetNerdFontCache()
			expect(isNerdFontSupported()).toBe(true)
		})

		it("should respect BROCODE_NERD_FONT=0 environment variable", () => {
			process.env.BROCODE_NERD_FONT = "0"
			resetNerdFontCache()
			expect(isNerdFontSupported()).toBe(false)
		})

		it("should respect BROCODE_NERD_FONT=false environment variable", () => {
			process.env.BROCODE_NERD_FONT = "false"
			resetNerdFontCache()
			expect(isNerdFontSupported()).toBe(false)
		})
