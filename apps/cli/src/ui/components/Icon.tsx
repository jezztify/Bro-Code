 ...
 *
 * Users can override this with the BROCODE_NERD_FONT environment variable:
 * - BROCODE_NERD_FONT=0 to force ASCII fallbacks (if icons don't render correctly)
 * - BROCODE_NERD_FONT=1 to force Nerd Font icons
 *
...
function detectNerdFontSupport(): boolean {
	...
	const envOverride = process.env.BROCODE_NERD_FONT
	...
	// and users can set BROCODE_NERD_FONT=0 if needed
	return true
}
