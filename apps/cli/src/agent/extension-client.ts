...
import type { ExtensionMessage, WebviewMessage, ClineAskResponse, ClineMessage, ClineAsk } from "@bro-code/types"
...
/**
 * ExtensionClient is the main interface for interacting with the Bro Code extension.
 *
 * Basic usage:
 * ```typescript
