...
import type { TaskSessionEntry } from "@bro-code/core/cli"
...
async function main() {
	const cliRoot = process.env.BRO_CLI_ROOT
		? path.resolve(process.env.BRO_CLI_ROOT)
		: path.resolve(__dirname, "../../..")
	const workspacePath = await fs.mkdtemp(path.join(os.tmpdir(), "bro-cli-create-session-id-"))
