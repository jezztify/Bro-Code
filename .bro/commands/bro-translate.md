---
description: "Translate and localize strings in the Bro Code extension"
argument-hint: "[language-code or 'all'] [string-key or file-path]"
mode: translate
---

Perform translation and localization tasks for the Bro Code extension. This command activates the translation workflow with comprehensive i18n guidelines.
...
- `/bro-translate de` - Focus on German translations
- `/bro-translate all welcome.title` - Translate a specific key to all languages
- `/bro-translate zh-CN src/i18n/locales/zh-CN/core.json` - Work on specific file
