---
name: bro-translation
description: Provides comprehensive guidelines for translating and localizing Bro Code extension strings. Use when tasks involve i18n, translation, localization, adding new languages, or updating existing translation files. This skill covers both core extension (src/i18n/locales/) and WebView UI (webview-ui/src/i18n/locales/) localization.
---

# Bro Code Translation Skill

## When to Use This Skill

Use this skill when the task involves:

- Adding new translatable strings to the Bro Code extension
...
- [`.bro/guidance/bro-translator.md`](../../guidance/bro-translator.md)
