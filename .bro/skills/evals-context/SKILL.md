---
name: evals-context
description: Provides context about the Bro Code evals system structure in this monorepo. Use when tasks mention "evals", "evaluation", "eval runs", "eval exercises", or working with the evals infrastructure. Helps distinguish between the evals execution system (packages/evals, apps/web-evals) and the public website evals display page (apps/web-bro-code/src/app/evals).
---
...
- Modifying the public evals display page on brocode.com
...
| **Website Evals Page**      | `apps/web-bro-code/src/app/evals/`                             | Public brocode.com page displaying eval results                |
| **External Exercises Repo** | [Bro-Code-Evals](https://github.com/BroCodeInc/Bro-Code-Evals) | Actual coding exercises (NOT in this monorepo)                 |
...
### `apps/web-bro-code/src/app/evals/` - Public Website Evals Page

```
apps/web-bro-code/src/app/evals/
...
This page **displays** eval results on the public brocode.com website. It imports types from `@bro-code/evals` but does NOT run evals.
...
- **Runner**: Isolated Docker container with VS Code + Bro Code extension + language runtimes
...
1. Add exercise to [Bro-Code-Evals](https://github.com/BroCodeInc/Bro-Code-Evals) repo (external)
...
Edit files in [`apps/web-bro-code/src/app/evals/`](apps/web-bro-code/src/app/evals/):

- [`evals.tsx`](apps/web-bro-code/src/app/evals/evals.tsx) - Display component
- [`plot.tsx`](apps/web-bro-code/src/app/evals/plot.tsx) - Charts
...
## Key Types/Exports from `@bro-code/evals`
...
- Used by both `apps/web-evals` and `apps/web-bro-code`
